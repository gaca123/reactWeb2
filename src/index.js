...
export default class App extends React.Component {
    ...
    render() {
        return (
                <Fetch url="http://localhost:9092/schemaExample2">
                    <TestComponent/>
                </Fetch>
                )
    }
...
class TestComponent extends React.Component {
    render() {
        ...
        return (<Fetch url="http://localhost:9092/formExample2">
            <TestComponent1/>
        </Fetch>);
    }
...
class TestComponent1 extends React.Component {
    render() {
        ...
        return (<Fetch url="http://localhost:9092/modelExample2">
            <TestComponent2/>
        </Fetch>);
    }
...
class TestComponent2 extends React.Component {
    render() {
        ...
        //console.log(schema);
        return <div><Form schema ={schema} uiSchema={uiSchema} formData = {formData} onSubmit={onSubmit}/>;</div>;
    }
